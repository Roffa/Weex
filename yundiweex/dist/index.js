...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-rich-text/wxc-rich-text-text.vue"
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-checkbox/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-rich-text/wxc-rich-text-tag.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
/* global Vue */
var router = __webpack_require__(16); //导入路由文件
var App = __webpack_require__(262); //导入根组件
/* eslint-disable no-new */
new Vue(Vue.util.extend({ el: '#root', router: router }, App)); //‘#root根组件id  等同 App.el = '#root'
    ...
    methods: {
        ...
        push: function push(path) {
            if (WXEnvironment.platform === 'Android') {
                var nativeBase = 'file://assets/dist/pages/';
                var native = nativeBase + path + ".js";
                weex.requireModule('navigator').push({
                    url: native,
                    animated: 'true'
                });
            } else if (WXEnvironment.platform === 'iOS') {
                var _nativeBase = weex.config.bundleUrl.substring(0, weex.config.bundleUrl.lastIndexOf('/') + 1);
                var _native = _nativeBase + 'pages/' + path + ".js";
                weex.requireModule('navigator').push({
                    url: _native,
                    animated: 'true'
                });
            } else {
                var _nativeBase2 = weex.config.bundleUrl.substring(0, weex.config.bundleUrl.lastIndexOf('/') + 1);
                var _native2 = _nativeBase2 + '#/' + path;
                weex.requireModule('navigator').push({
                    url: _native2,
                    animated: 'true'
                });
                console.log('=========' + _native2);
        ...
        *
        */
        showRequestError: function showRequestError(str, interval) {
            if (!!str) {
        ...
        GET: function GET(api, succ, fail) {
        ...
        * @callback 失败回调
        */
        POST: function POST(api, objParams, succ, fail) {
            var me = this;
            var stream = weex.requireModule('stream');
...
var _Studio = __webpack_require__(18);

var _Studio2 = _interopRequireDefault(_Studio);

var _Report = __webpack_require__(250);
...
exports.default = {
    components: { WxcLoading: _weexUi.WxcLoading, WxcPartLoading: _weexUi.WxcPartLoading, WxcDialog: _weexUi.WxcDialog, WxcMask: _weexUi.WxcMask },
    data: function data() {
        return {
            //点击加入工作室  
            showAdd: false,
    ...
    methods: {
        getStudioInfoRequest: function getStudioInfoRequest() {
            var me = this;
        ...
        getStudioInfo: function getStudioInfo() {
            //获取工作室信息
            var me = this;
            if (WXEnvironment.platform == 'Web') {
                me.isWeb = true;
                ...
                me.mainColor = { 'background-color': '#6e1419' }, me.mainTextColor = { 'color': '#6e1419' };
                me.themeColorHexStr = '#6e1419';

                me.getStudioInfoRequest();
            } else {
                studioEvent.getNativeAppInfo(function (ret) {
                    me.scbaseUrl = ret.baseUrl, me.baseUrl = ret.baseUrl, me.studioId = ret.studioId, me.userId = ret.userId;
                    me.mainColor = { 'background-color': '#' + ret.mainColorValue }, //
                    me.mainTextColor = { 'color': '#' + ret.mainColorValue }; //
                    storage.setItem("baseUrl", ret.baseUrl, function (event) {});
        ...
        //加入工作室
        didClickjoinBtn: function didClickjoinBtn() {
            var me = this;
            me.showAdd = true;
            me.addStudioRequest();
        ...
        //点击加入工作室后响应
        addStudioRequest: function addStudioRequest() {
            var _this = this;
            ...
            this.addStudioInfoStyle = { 'margin-top': '30px'
                ...
                _this.showHubLoading = false;
                if (succ.syb_status !== '900' && succ.syb_status !== '103') {
                    _this.addStudioInfo = succ.syb_info;
                    ...
                    if (succ.syb_info.length < 1) {
                        _this.addStudioInfo = '该工作室暂不支持加入';
                    } else {
                        _this.addStudioInfo = succ.syb_info;
                    }
                ...
                if (_this.showCancelBtn) {
                    //显示取消申请按钮
                    if (_this.Web()) {
                        //显示取消申请与下载APP按钮
                        _this.addStudioInfoStyle = { 'margin-top': '20px' };
                        _this.cancelStyle = { 'margin-top': '20px', 'background-color': _this.themeColorHexStr };
                        _this.downloadStyle = { 'margin-top': '20px', 'background-color': _this.themeColorHexStr };
                    } else {
                        //只显示取消申请按钮
                        _this.addStudioInfoStyle = { 'margin-top': '80px' };
                        _this.cancelStyle = { 'margin-top': '70px', 'background-color': _this.themeColorHexStr };
                    }
                } else {
                    if (_this.Web()) {
                        //显示下载APP按钮
                        ...
                        _this.addStudioInfoStyle = { 'margin-top': '80px' };
                        _this.downloadStyle = { 'margin-top': '70px', 'background-color': _this.themeColorHexStr };
                    } else {
                        //不显示按钮
                        _this.addStudioInfoStyle = { 'margin-top': '120px' };
                    }
                }
            }, function (fail) {
                _this.showHubLoading = false;
                _this.addStudioInfo = fail;
                _this.showCancelBtn = false;
                _this.addStudioInfoStyle = { 'margin-top': '100px' };
            });
        },
        //跳转商城
        didClickPurchaseBtn: function didClickPurchaseBtn(arg) {
        ...
        //退出工作室
        didClickExitBtn: function didClickExitBtn() {
            var me = this;
            me.showDialog = true;
        },
        ...
        cancelApply: function cancelApply() {
            ...
            this.GET(apiName, function (succ) {
                _this2.showHubLoading = false;
                if (succ.syb_status === '000') {
                    _this2.showCancelBtn = false;
                    _this2.addStudioInfo = '取消申请加入工作室成功';
                    _this2.addStudioInfoStyle = { 'margin-top': '100px' };
        ...
        downloadAppClicked: function downloadAppClicked() {
            //下载APP
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-button/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-cell/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-checkbox-list/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-city/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-city/tab.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-searchbar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-result/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-indexlist/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-countdown/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-dialog/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-overlay/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-ep-slider/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-tab-page/full-page.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-grid-select/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-grid-select/option.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-icon/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-lightbox/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-mask/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-loading/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-lottery-rain/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-lottery-rain/rain-item.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-minibar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-noticebar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-page-calendar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-pan-item/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-part-loading/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-popover/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-popup/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-progress/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-radio/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-radio/item.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-refresher/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-rich-text/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-rich-text/wxc-rich-text-link.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-rich-text/wxc-rich-text-icon.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-simple-flow/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-slide-nav/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-slider-bar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-special-rich-text/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-stepper/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-tab-bar/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-tab-page/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/node_modules/weex-ui/packages/wxc-tag/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.isLoadFinish) ? _c('div', [(_vm.lists.length != 0) ? _c('div', [_c('list', {
    ...
    }, [_vm._v(_vm._s(_vm.addStudioBtnTitle))])]) : _vm._e()])])]), _c('div', {
      staticClass: ["sepline"]
    }), _c('div', {
    ...
    staticClass: ["add-studio-content"]
  }, [_c('div', {
    staticClass: ["add-studio-title"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("加入工作室")])]), _c('div', [_c('text', {
    staticClass: ["add-studio-text"],
    style: _vm.addStudioInfoStyle
  }, [_vm._v(_vm._s(_vm.addStudioInfo))])]), (_vm.showCancelBtn) ? _c('text', {
    staticClass: ["add-studio-btn"],
    style: _vm.cancelStyle,
    on: {
      "click": _vm.cancelApply
    }
  }, [_vm._v("取消申请")]) : _vm._e(), (_vm.bWeb) ? _c('text', {
    staticClass: ["add-studio-btn"],
    style: _vm.downloadStyle,
    on: {
      "click": _vm.downloadAppClicked
    }
  }, [_vm._v("马上下载App")]) : _vm._e(), _c('wxc-loading', {
    attrs: {
      "show": _vm.showHubLoading,
      "type": _vm.loadingType,
      "interval": "1000"
    }
  })], 1)])], 1) : _c('div', [_c('wxc-loading', {
    attrs: {
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/src/pages/Report.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-76a746d8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _BorderBottomText = __webpack_require__(253);

var _BorderBottomText2 = _interopRequireDefault(_BorderBottomText);
...
exports.default = {
    components: {
        'border-text': _BorderBottomText2.default,
        'sctable': _Table2.default
    },
    data: function data() {
        return {
            baseUrl: '',
            ...
            arrayRows: [["日期和时间", "测量时段", "血糖(mmol/l)"]],
            chartUrl: '',
            hasReport: false
        };
    },
    ...
    methods: {
        getGlucoseReport: function getGlucoseReport() {
            //血糖报告
            var me = this;
            ...
            if (WXEnvironment.platform == 'Web') {
                ...
                me.chartUrl = me.scbaseUrl + '/glucose/toBloodGlucoseReportPhone.mv' + '?' + 'userId=' + me.userId;
                studioEvent.getNativeAppInfo(function (ret) {
                    me.scbaseUrl = ret.baseUrl, me.baseUrl = ret.baseUrl, me.userId = ret.userId;
                    me.getGlucoseReportRequest();
                });
            }
        },
        getGlucoseReportRequest: function getGlucoseReportRequest() {
            //获取血糖报告
            var me = this;
            var stream = weex.requireModule('stream');
            ...
            me.GET(apiName, function (succ) {

                var result = JSON.parse(succ.syb_data);
        ...
        getGlucoseDataRequest: function getGlucoseDataRequest() {
            //获取血糖测量数据
            var me = this;
            var stream = weex.requireModule('stream');

            var apiName = '/glucose/getBloodGlucoseList.mv' + '?' + 'reportId=' + me.reportId; //

            me.GET(apiName, function (succ) {

                var result = succ.syb_data;
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/src/components/BorderBottomText.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-383e1574"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/src/components/Table.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-783f90ce"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', _vm._l((_vm.rows), function(row, i) {
    return _c('div', {
      ...
      return _c('div', {
        ...
        class: [j < 1 ? 'table-left' : '']
      }, [_c('text', {
        staticClass: ["tlt"],
        class: [i < 1 ? 'text-header' : '']
      }, [_vm._v(_vm._s(row[j]))])])
    }))
  }))
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["wrapper"]
  }, [(_vm.hasReport) ? _c('div', [_c('scroller', {
    ...
    staticClass: ["user-info-normal", "user-info-bold"]
  }, [_vm._v("姓名:  ")]), _c('text', {
    staticClass: ["user-info-normal", "user-info-nick"]
  }, [_vm._v(_vm._s(_vm.basicInfo.nickname))]), _c('text', {
    staticClass: ["user-info-normal", "user-info-bold", "user-info-generate"]
  }, [_vm._v("报告生成时间:  ")]), _c('text', {
    staticClass: ["user-info-normal", "user-info-time"]
  }, [_vm._v(_vm._s(_vm.basicInfo.generateTime))])])], 1), _c('border-text', {
    staticClass: ["text"],
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.report.desc))]), _c('border-text', {
    staticClass: ["text"],
    attrs: {
      "title": _vm.glucoseChart.title,
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/src/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
