...
var App = __webpack_require__(266); //导入根组件
...
var _AddStudio = __webpack_require__(262);

var _AddStudio2 = _interopRequireDefault(_AddStudio);
...
exports.default = {
    components: { WxcLoading: _weexUi.WxcLoading, WxcPartLoading: _weexUi.WxcPartLoading, WxcDialog: _weexUi.WxcDialog },
    data: function data() {
        return {
            isLoadFinish: false,
            romeName: '',
        ...
        getStudioInfo: function getStudioInfo() {
            ...
            if (WXEnvironment.platform == 'Web') {
                ...
                studioEvent.getNativeAppInfo(function (ret) {
                    me.baseUrl = ret.baseUrl, me.studioId = ret.studioId, me.userId = ret.userId;
                    me.mainColor = { 'background-color': '#' + ret.mainColorValue }, me.mainTextColor = { 'color': '#' + ret.mainColorValue };
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            report: {
                title: '小结报告',
                desc: '安联大厦就中西里菜欧尼企鹅哦排位离开家咱妈先从女群殴IE我去我诶阿拉拉了坎坎坷坷所多哦且为全额召开程序鸡尾酒Ada落实到付款'
            },
            arrayRows: [["日期和时间", "测量时段", "血糖(mmol/l)"], ["20181018", "早餐前", "5.1"], ["20181018", "早餐后", "8.8"], ["20181022", "早餐前", "6.1"], ["20181022", "晚餐前", "4.8"], ["20181024", "早餐后", "9.3"]]
    ...
    created: function created() {
        ...
        //             console.log('开始网络')
        // let me = this;
        // let GET_URL = '/studio/serviceCfgInfo.mv?' + 'userId=4028808462900e0a0162a314a5880116' + '&studioId=000100010001' ;

        //     me.scbaseUrl = 'https://jkbtest.sybercare.com'

        //     me.GET(GET_URL, function(succ){
        //             console.log('get:'+succ);
        //             me.report.title = succ    
        //     }, fail => {          
        //         me.report.title = fail               
        //     });
        //         }, 100)
    },

    methods: {
        jumpview: function jumpview(e) {
            console.log("点我点点");
            this.push('AddStudio');
            // this.$router.push({name:"AddStudio"})
        }
        // GET (api, succ, fail) {
        //       let me = this;
        ...
        //       stream.fetch({
        //           method: 'GET',
        //           url: 'https://jkbtest.sybercare.com/'+api,
        //           type:'json'
        //       }, function(ret) {
        //           if(!ret.ok){
        //             me.report.title = "failed"+JSON.stringify(ret);
        //           }else{
        //             console.log('get:'+ret);
        //             me.report.title =  JSON.stringify(ret.data);
        //            }
        //       },function(response){
        //           console.log('get jsonp in progress:'+response.length);
        //           me.report.title = "bytes received:"+response.length;
        //       });
        //   },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.basicInfo.generateTime))])]), _c('button', {
    on: {
      "click": _vm.jumpview
    }
  }, [_vm._v("alkdjfaldfksjaldfjks")])], 1), _c('border-text', {
    staticClass: ["text"],
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.report.desc))])], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
...
__vue_options__.__file = "/Users/guanliyuan/Documents/jiankangyun/yundiweex/src/pages/AddStudio.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3531c73a"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
  ...
  methods: {
    addStudioRequest: function addStudioRequest() {
      ...
      stream.fetch({ //https://jkbtest.sybercare.com/
        method: 'POST',
        type: 'json',
        url: 'http://192.168.1.43:8080/' + 'services/RestServices/yundihealth/users/joinInWorkroom',
        body: this.toParams({
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("12sdfadsfafdadfadfadfasdfasdfadsfadsfadsfasdfasdf")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
